...
impl crate::framework::ExampleTrait for Example {
...
static TEST: crate::framework::ExampleTestParams = crate::framework::ExampleTestParams {
    ...
    base_test_parameters: wgpu_test::TestParameters {
        required_features: <Example as crate::framework::ExampleTrait>::required_features(),
        required_limits: <Example as crate::framework::ExampleTrait>::required_limits(),
        force_fxc: false,
        skips: vec![],
        failures: Vec::new(),
        required_downlevel_caps:
            <Example as crate::framework::ExampleTrait>::required_downlevel_capabilities(),
    },
