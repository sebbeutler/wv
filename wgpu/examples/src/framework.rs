...
pub trait ExampleTrait: 'static + Sized {
...
async fn start<E: ExampleTrait>(title: &str) {
    init_logger();
...
pub fn run<E: ExampleTrait>(title: &'static str) {
    cfg_if::cfg_if! {
        if #[cfg(target_arch = "wasm32")] {
...
#[cfg(test)]
impl<E: ExampleTrait + wgpu::WasmNotSendSync> From<ExampleTestParams<E>>
