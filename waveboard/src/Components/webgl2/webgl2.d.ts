...
export interface InitOutput {
  ...
  readonly closure406_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure408_externref_shim: (a: number, b: number, c: any) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h4a681bc856c31ecc: (a: number, b: number) => void;
